...
const About = () => {
  return (
    <section className='mt-10 xl:mt-16 sm:container px-4 md:px-0 mx-auto relative'>
              <div className="absolute z-0 left-1/3 top-40  lg:-top-52 -translate-x-1/4 w-[700px] h-[200px]  lg:h-[1000px] lg:w-[400px] rotate-[60deg]  lg:rotate-[130deg]  bg-white/25 opacity-30 blur-3xl rounded-full md:flex hidden"></div>
